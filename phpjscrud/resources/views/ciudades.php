	...
	<div class="card" style="width:90%;margin: 30px auto;">
		<div class="card-header">
			<div class="row">
				...
				<div class="col-3">
					<button class="btn btn-primary disabled" id="ver-ciudades">Ver</button>
					<button class="btn btn-warning" id="nueva-ciudad" data-toggle="modal" data-target="#modal-insertar-ciudad">Nueva</button>
				</div>
			</div>
		</div>
		<div class="card-body">
